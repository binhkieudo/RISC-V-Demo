...
module Frontend(
  ...
  assign _io_cpu_npc_T_3 = ~(~(io_cpu_req_valid ? io_cpu_req_bits_pc : s2_replay ? s2_pc : ~(~s1_pc | 40'h3) + 40'h4) | 40'h1);	// @[Frontend.scala:110:18, :112:22, :123:{20,22,29}, :124:25, :129:46, :130:16, :181:28, :376:{27,29,33}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_tlb_resp_miss = _RANDOM_4[11];	// @[Frontend.scala:116:24]
        s2_tlb_resp_pf_inst = _RANDOM_6[23];	// @[Frontend.scala:116:24]
        s2_tlb_resp_gf_inst = _RANDOM_6[26];	// @[Frontend.scala:116:24]
        s2_tlb_resp_ae_inst = _RANDOM_6[29];	// @[Frontend.scala:116:24]
        s2_tlb_resp_cacheable = _RANDOM_7[1];	// @[Frontend.scala:116:24]
        s2_speculative = _RANDOM_7[4];	// @[Frontend.scala:116:24, :118:31]
        s2_replay_REG = _RANDOM_7[23];	// @[Frontend.scala:116:24, :129:56]
        recent_progress_counter = _RANDOM_7[25:24];	// @[Frontend.scala:116:24, :150:40]
        fq_io_enq_valid_REG = _RANDOM_7[26];	// @[Frontend.scala:116:24, :179:29]
        gpa_valid = _RANDOM_7[27];	// @[Frontend.scala:116:24, :348:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ICache icache (	// @[Frontend.scala:65:26]
    ...
    .io_s1_kill                     (io_cpu_req_valid | _tlb_io_resp_miss | s2_replay),	// @[Frontend.scala:100:19, :129:46, :173:56]
  ...
  ShiftQueue fq (	// @[Frontend.scala:86:64]
    ...
    .io_enq_bits_replay       (_icache_io_resp_bits_replay | _icache_io_s2_kill_T_2 & ~_icache_io_resp_valid & ~s2_xcpt | _fq_io_enq_bits_replay_T_5),	// @[Frontend.scala:65:26, :117:60, :175:71, :179:112, :185:{80,102,105,115}]
