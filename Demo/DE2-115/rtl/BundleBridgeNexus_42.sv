...
module BundleBridgeNexus_42(
  ...
  wire [1:0] outputs_0 = 2'h0;	// @[HasTiles.scala:159:32]
  wire [1:0] outputs_1 = 2'h1;	// @[HasTiles.scala:159:32]
  wire [1:0] outputs_2 = 2'h2;	// @[HasTiles.scala:159:32]
  wire [1:0] outputs_3 = 2'h3;	// @[HasTiles.scala:159:32]
