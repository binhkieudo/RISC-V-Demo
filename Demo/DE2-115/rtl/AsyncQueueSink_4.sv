...
module AsyncQueueSink_4(
  ...
  wire [20:0] _io_deq_bits_deq_bits_reg_io_q;	// @[SynchronizerReg.scala:207:25]
  ...
  ClockCrossingReg_w21 io_deq_bits_deq_bits_reg (	// @[SynchronizerReg.scala:207:25]
    .clock (clock),
    .io_d  ({io_async_mem_0_resumereq, io_async_mem_0_hartsel, io_async_mem_0_ackhavereset, io_async_mem_0_hasel, io_async_mem_0_hamask_3, io_async_mem_0_hamask_2, io_async_mem_0_hamask_1, io_async_mem_0_hamask_0, io_async_mem_0_hrmask_3, io_async_mem_0_hrmask_2, io_async_mem_0_hrmask_1, io_async_mem_0_hrmask_0}),	// @[SynchronizerReg.scala:209:24]
  ...
  assign io_deq_bits_resumereq = _io_deq_bits_deq_bits_reg_io_q[20];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hartsel = _io_deq_bits_deq_bits_reg_io_q[19:10];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_ackhavereset = _io_deq_bits_deq_bits_reg_io_q[9];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hasel = _io_deq_bits_deq_bits_reg_io_q[8];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hamask_0 = _io_deq_bits_deq_bits_reg_io_q[4];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hamask_1 = _io_deq_bits_deq_bits_reg_io_q[5];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hamask_2 = _io_deq_bits_deq_bits_reg_io_q[6];	// @[SynchronizerReg.scala:207:25, :211:26]
  assign io_deq_bits_hamask_3 = _io_deq_bits_deq_bits_reg_io_q[7];	// @[SynchronizerReg.scala:207:25, :211:26]
