...
module SimpleHellaCacheIF(
  ...
  wire [8:0]  _req_arb_io_out_bits_tag;	// @[SimpleHellaCacheIF.scala:104:23]
  ...
  wire [8:0]  _replayq_io_replay_bits_tag;	// @[SimpleHellaCacheIF.scala:103:23]
  ...
  reg  [8:0]  s1_req_tag;	// @[SimpleHellaCacheIF.scala:121:27]
  reg  [8:0]  s2_req_tag;	// @[SimpleHellaCacheIF.scala:122:27]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_tag = _RANDOM_0[10:2];	// @[SimpleHellaCacheIF.scala:119:28, :121:27]
        s2_req_tag = _RANDOM_0[19:11];	// @[SimpleHellaCacheIF.scala:119:28, :122:27]
        REG = _RANDOM_0[20];	// @[SimpleHellaCacheIF.scala:119:28, :124:18]
        io_cache_s1_data_data_r = {_RANDOM_0[31:21], _RANDOM_1, _RANDOM_2[20:0]};	// @[Reg.scala:19:16, SimpleHellaCacheIF.scala:119:28]
      `endif // RANDOMIZE_REG_INIT
    end // initial
