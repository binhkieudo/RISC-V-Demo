  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        buf_pc = {_RANDOM_1[31:24], _RANDOM_2};	// @[IBuf.scala:35:16]
        buf_data = _RANDOM_3;	// @[IBuf.scala:35:16]
        buf_xcpt_pf_inst = _RANDOM_4[2];	// @[IBuf.scala:35:16]
        buf_xcpt_gf_inst = _RANDOM_4[3];	// @[IBuf.scala:35:16]
        buf_xcpt_ae_inst = _RANDOM_4[4];	// @[IBuf.scala:35:16]
        buf_replay = _RANDOM_4[5];	// @[IBuf.scala:35:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
