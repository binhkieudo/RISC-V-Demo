...
module TLAtomicAutomata_1(
  ...
  wire            _a_canArithmetic_T_54 = auto_in_a_bits_size < 4'h4;	// @[Parameters.scala:92:42]
  ...
  wire [5:0]      _GEN_0 = {auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14:13] ^ 2'h2};	// @[AtomicAutomata.scala:83:44, Parameters.scala:137:{31,45}]
  ...
  wire [5:0]      _GEN_3 = {~(auto_in_a_bits_address[30]), auto_in_a_bits_address[26:25], auto_in_a_bits_address[20], auto_in_a_bits_address[16], auto_in_a_bits_address[14]};	// @[Parameters.scala:137:{31,45}]
  wire            a_isSupported = auto_in_a_bits_opcode == 3'h3 ? _a_canArithmetic_T_54 & (_GEN == 7'h0 | _GEN_0 == 6'h0 | _GEN_2 == 6'h0) | (|(auto_in_a_bits_size[3:1])) & _a_canArithmetic_T_54 & _GEN_3 == 6'h0 : auto_in_a_bits_opcode != 3'h2 | _a_canArithmetic_T_54 & (_GEN == 7'h0 | _GEN_0 == 6'h0 | _GEN_2 == 6'h0) | (|(auto_in_a_bits_size[3:1])) & _a_canArithmetic_T_54 & _GEN_3 == 6'h0;	// @[AtomicAutomata.scala:92:47, :93:47, :94:{32,63}, Mux.scala:81:61, Parameters.scala:92:{32,42}, :137:{45,65}, :671:54, :672:42, :673:26]
  ...
  wire [6:0]      _GEN_4 = ~(cam_a_0_bits_mask[6:0]) | cam_a_0_bits_mask[7:1];	// @[AtomicAutomata.scala:79:24, :123:{25,31,39}]
  wire [6:0]      _GEN_5 = {cam_a_0_bits_data[55], cam_a_0_bits_data[47], cam_a_0_bits_data[39], cam_a_0_bits_data[31], cam_a_0_bits_data[23], cam_a_0_bits_data[15], cam_a_0_bits_data[7]} & ~_GEN_4;	// @[AtomicAutomata.scala:79:24, :115:63, :123:{23,31}, :127:38, Cat.scala:33:92]
  wire [6:0]      _GEN_6 = {cam_d_0_data[55], cam_d_0_data[47], cam_d_0_data[39], cam_d_0_data[31], cam_d_0_data[23], cam_d_0_data[15], cam_d_0_data[7]} & ~_GEN_4;	// @[AtomicAutomata.scala:80:24, :115:73, :123:{23,31}, :128:38, Cat.scala:33:92]
  wire [5:0]      _GEN_7 = _GEN_5[6:1] | _GEN_5[5:0];	// @[AtomicAutomata.scala:127:38, package.scala:245:{43,53}]
  wire [3:0]      _GEN_8 = _GEN_7[5:2] | _GEN_7[3:0];	// @[package.scala:245:{43,53}]
  wire            _signext_a_T_24 = _GEN_7[1] | _GEN_5[0];	// @[AtomicAutomata.scala:127:38, package.scala:245:43]
  wire [5:0]      _GEN_9 = _GEN_6[6:1] | _GEN_6[5:0];	// @[AtomicAutomata.scala:128:38, package.scala:245:{43,53}]
  wire [3:0]      _GEN_10 = _GEN_9[5:2] | _GEN_9[3:0];	// @[package.scala:245:{43,53}]
  wire            _signext_d_T_24 = _GEN_9[1] | _GEN_6[0];	// @[AtomicAutomata.scala:128:38, package.scala:245:43]
  ...
  wire [63:0]     a_a_ext = cam_a_0_bits_data & wide_mask | {{8{_GEN_8[3] | _signext_a_T_24}}, {8{_GEN_8[2] | _GEN_7[0]}}, {8{_GEN_8[1] | _GEN_5[0]}}, {8{_GEN_8[0]}}, {8{_signext_a_T_24}}, {8{_GEN_7[0]}}, {8{_GEN_5[0]}}, 8'h0};	// @[AtomicAutomata.scala:79:24, :127:38, :133:{28,41}, Bitwise.scala:77:12, Cat.scala:33:92, package.scala:245:43]
  wire [63:0]     a_d_ext = cam_d_0_data & wide_mask | {{8{_GEN_10[3] | _signext_d_T_24}}, {8{_GEN_10[2] | _GEN_9[0]}}, {8{_GEN_10[1] | _GEN_6[0]}}, {8{_GEN_10[0]}}, {8{_signext_d_T_24}}, {8{_GEN_9[0]}}, {8{_GEN_6[0]}}, 8'h0};	// @[AtomicAutomata.scala:80:24, :128:38, :134:{28,41}, Bitwise.scala:77:12, Cat.scala:33:92, package.scala:245:43]
  ...
  wire [3:0][3:0] _GEN_11 = '{4'hC, 4'h8, 4'hE, 4'h6};	// @[Mux.scala:81:{58,61}]
  wire            _GEN_12 = out_1_ready & out_1_earlyValid & ~a_isSupported & cam_free_0;	// @[Arbiter.scala:124:31, AtomicAutomata.scala:79:24, :82:44, :94:32, :153:38, :155:15, :176:50, :178:23, :179:24]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      else if (_GEN_12)	// @[AtomicAutomata.scala:79:24, :176:50, :178:23, :179:24]
    ...
    if (_GEN_12) begin	// @[AtomicAutomata.scala:79:24, :176:50, :178:23, :179:24]
      ...
      cam_a_0_lut <= _GEN_11[auto_in_a_bits_param[1:0]];	// @[AtomicAutomata.scala:79:24, :181:52, Mux.scala:81:{58,61}]
    end
    cam_a_0_fifoId <= ~_GEN_12 & cam_a_0_fifoId;	// @[AtomicAutomata.scala:79:24, :176:50, :178:23, :179:24]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        d_first_counter = _RANDOM_6[19:11];	// @[Arbiter.scala:88:30, Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
