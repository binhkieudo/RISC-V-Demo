...
module TilePRCIDomain_1(
  ...
  input  [30:0] auto_tl_slave_clock_xing_in_a_bits_address,
  ...
  RocketTile_1 tile_reset_domain_tile (	// @[HasTiles.scala:251:53]
    ...
    .int_read_empty                 (int_read_empty     ),
    .int_read_data                  (int_read_data      ),
    .int_read_en                    (int_read_en        ),
    .int_write_full                 (int_write_full     ),
    .int_write_data                 (int_write_data     ),
    .int_write_en                   (int_write_en       ),
    .fifo_read_full                 (fifo_read_full     ),
    .fifo_read_din                  (fifo_read_din      ),
    .fifo_read_wren                 (fifo_read_wren     ),
    .fifo_write_empty               (fifo_write_empty   ),
    .fifo_write_dout                (fifo_write_dout    ),
    .fifo_write_rden                (fifo_write_rden    )
  );
  ...
  TLBuffer buffer_1 (	// @[Buffer.scala:69:28]
    ...
    .auto_out_d_bits_param   (2'h0),	// @[Buffer.scala:69:28]
