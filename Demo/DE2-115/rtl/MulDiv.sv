...
module MulDiv(
  ...
  wire [96:0]  _GEN = {{65{remainder[64]}}, remainder[31:0]} * {{32{divisor[64]}}, divisor} + {{32{remainder[129]}}, remainder[129:65]};	// @[Multiplier.scala:57:20, :58:22, :104:31, :105:31, :106:24, :109:{38,67,76}]
  wire [64:0]  subtractor = remainder[128:64] - divisor;	// @[Multiplier.scala:57:20, :58:22, :85:{29,37}]
  wire         divby0 = ~(|count) & ~(subtractor[64]);	// @[Multiplier.scala:51:18, :85:37, :111:32, :130:28, :143:{24,32,35}]
  ...
  wire [64:0]  _eOutMask_T_2 = $signed(65'sh10000000000000000 >>> {59'h0, count[0], 5'h0});	// @[Multiplier.scala:51:18, :113:{44,54,72}]
  wire         eOut = count != 7'h1 & (|count) & ~isHi & (remainder[63:0] & ~(_eOutMask_T_2[63:0])) == 64'h0;	// @[Multiplier.scala:51:18, :55:17, :58:22, :86:57, :113:{44,91}, :114:{45,83}, :115:{7,13,24,26,37}]
  wire         _GEN_0 = _T_14 & (eOut | count == 7'h1);	// @[Multiplier.scala:51:18, :98:57, :103:{39,50}, :114:45, :115:13, :121:{16,25,55}, :122:13]
  ...
  wire [128:0] eOutRes = {remainder[129:65], remainder[63:0]} >> 6'h0 - {count[0], 5'h0};	// @[Cat.scala:33:92, Multiplier.scala:51:18, :58:22, :86:57, :104:31, :113:{54,72}, :116:{27,38}]
  always @(posedge clock) begin
    ...
    if (_T_23) begin	// @[Decoupled.scala:51:35]
      ...
      count <= 7'h0;	// @[Multiplier.scala:51:18, :165:11]
      ...
      if (_T_17) begin	// @[Multiplier.scala:126:39]
        if (~(|count) & ~divby0 & _eOutPos_T_1 != 6'h3F) begin	// @[Multiplier.scala:51:18, :111:32, :143:{24,32}, :149:{21,35}, :150:{35,43,54}]
          ...
          count <= count + 7'h1;	// @[Multiplier.scala:51:18, :114:45, :141:20]
        ...
        count <= count + 7'h1;	// @[Multiplier.scala:51:18, :114:45, :120:20]
        remainder <= {_GEN[96:32], ~(|count) & neg_out, eOut ? eOutRes[63:0] : {_GEN[31:0], remainder[63:32]}};	// @[Cat.scala:33:92, Multiplier.scala:51:18, :54:20, :58:22, :106:24, :109:76, :110:38, :111:{32,61}, :115:13, :116:27, :117:{37,55}]
      end
  ...
  assign io_resp_bits_data = {req_dw ? result[63:32] : {32{result[31]}}, result[31:0]};	// @[Bitwise.scala:77:12, Cat.scala:33:92, Multiplier.scala:50:16, :86:19, :173:{65,82}, :174:{18,50}]
