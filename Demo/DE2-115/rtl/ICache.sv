...
module ICache(
  ...
  wire [3:0]  _tag_rdata_T_4;	// @[ICache.scala:418:42]
  ...
  wire [22:0] _tag_array_0_RW0_rdata;	// @[DescribedSRAM.scala:17:26]
  ...
  assign _tag_rdata_T_4 = io_req_bits_addr[9:6];	// @[ICache.scala:418:42]
  ...
  reg  [15:0] vb_array;	// @[ICache.scala:440:25]
  wire [15:0] _s1_vb_T_1 = vb_array >> io_s1_paddr[9:6];	// @[ICache.scala:440:25, :500:25, :850:21]
  assign s1_tag_hit_0 = _s1_vb_T_1[0] & _tag_array_0_RW0_rdata[21:0] == io_s1_paddr[31:10];	// @[DescribedSRAM.scala:17:26, ICache.scala:485:30, :500:25, :506:{26,33}, package.scala:155:13]
  assign writeEnable_0 = refill_one_beat & ~invalidated;	// @[ICache.scala:359:24, :383:41, :562:{32,35}]
  wire [6:0]  writeAddr = refill_one_beat ? {refill_paddr[9:6], 3'h0} | refill_cnt[6:0] : io_req_bits_addr[9:3];	// @[Edges.scala:234:25, ICache.scala:383:41, :557:31, :566:{10,40,67}, :850:21, Reg.scala:19:16]
  ...
  wire [31:0] _vb_array_T_3 = 32'h1 << refill_paddr[9:6];	// @[ICache.scala:444:32, :850:21, Reg.scala:19:16]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      vb_array <= 16'h0;	// @[ICache.scala:440:25]
    end
    else begin
      ...
      if (invalidate)	// @[ICache.scala:448:31, :644:{39,52}]
        ...
        vb_array <= writeEnable_1 & ~invalidated ? vb_array | _vb_array_T_3[15:0] : ~(~vb_array | _vb_array_T_3[15:0]);	// @[ICache.scala:359:24, :391:37, :440:25, :444:{32,72,75}]
    end
    ...
    if (s1_valid) begin	// @[ICache.scala:333:25]
      ...
      s2_tl_error <= s1_hit & _tag_array_0_RW0_rdata[22];	// @[DescribedSRAM.scala:17:26, ICache.scala:353:40, :510:32, Reg.scala:19:16, package.scala:155:13]
    end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        vb_array = _RANDOM_4[19:4];	// @[Edges.scala:229:27, ICache.scala:440:25]
        s2_dout_0 = {_RANDOM_5[31], _RANDOM_6[30:0]};	// @[Reg.scala:19:16]
        s2_tag_disparity_r_0 = _RANDOM_6[31];	// @[Reg.scala:19:16]
        s2_tl_error = _RANDOM_7[0];	// @[Reg.scala:19:16]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  tag_array_0 tag_array_0 (	// @[DescribedSRAM.scala:17:26]
    .RW0_addr  (writeEnable_1 ? refill_paddr[9:6] : _tag_rdata_T_4),	// @[DescribedSRAM.scala:17:26, ICache.scala:391:37, :418:42, :850:21, Reg.scala:19:16]
    ...
    .RW0_wdata ({refillError, refill_paddr[31:10]}),	// @[Cat.scala:33:92, ICache.scala:380:33, :422:43, Reg.scala:19:16]
