...
module TLXbar_2(
  ...
  output [30:0] auto_out_5_a_bits_address,
  ...
  wire        requestAIO_0_0 = {auto_in_a_bits_address[30], auto_in_a_bits_address[26], auto_in_a_bits_address[13:12]} == 4'h0;	// @[Parameters.scala:137:{45,65}, package.scala:254:43]
  wire        requestAIO_0_1 = {~(auto_in_a_bits_address[30]), auto_in_a_bits_address[26], auto_in_a_bits_address[13:12]} == 4'h0;	// @[Parameters.scala:137:{31,45,65}, package.scala:254:43]
  wire [4:0]  _GEN = auto_in_a_bits_address[30:26] ^ 5'h11;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_2 = {_GEN[4], _GEN[0], auto_in_a_bits_address[13:12]} == 4'h0;	// @[Parameters.scala:137:{31,45,65}, package.scala:254:43]
  wire [18:0] _GEN_0 = auto_in_a_bits_address[30:12] ^ 19'h44003;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_3 = {_GEN_0[18], _GEN_0[14], _GEN_0[1:0]} == 4'h0;	// @[Parameters.scala:137:{31,45,65}, package.scala:254:43]
  wire [18:0] _GEN_1 = auto_in_a_bits_address[30:12] ^ 19'h44001;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_4 = {_GEN_1[18], _GEN_1[14], _GEN_1[1:0]} == 4'h0;	// @[Parameters.scala:137:{31,45,65}, package.scala:254:43]
  wire [18:0] _GEN_2 = auto_in_a_bits_address[30:12] ^ 19'h44002;	// @[Parameters.scala:137:31]
  wire        requestAIO_0_5 = {_GEN_2[18], _GEN_2[14], _GEN_2[1:0]} == 4'h0;	// @[Parameters.scala:137:{31,45,65}, package.scala:254:43]
  reg  [2:0]  beatsLeft;	// @[Arbiter.scala:88:30]
  wire        idle = beatsLeft == 3'h0;	// @[Arbiter.scala:88:30, :89:28, Bundles.scala:259:74]
  wire [5:0]  readys_valid = {auto_out_5_d_valid, auto_out_4_d_valid, auto_out_3_d_valid, auto_out_2_d_valid, auto_out_1_d_valid, auto_out_0_d_valid};	// @[Cat.scala:33:92]
  reg  [5:0]  readys_mask;	// @[Arbiter.scala:24:23]
  wire [5:0]  _readys_filter_T_1 = readys_valid & ~readys_mask;	// @[Arbiter.scala:24:23, :25:{28,30}, Cat.scala:33:92]
  wire [4:0]  _GEN_3 = _readys_filter_T_1[4:0] | _readys_filter_T_1[5:1];	// @[Arbiter.scala:25:28, package.scala:254:43]
  wire        _GEN_4 = auto_out_5_d_valid | _readys_filter_T_1[0];	// @[Arbiter.scala:25:28, package.scala:254:43]
  ...
  wire        _GEN_7 = _GEN_3[3] | _readys_filter_T_1[5];	// @[Arbiter.scala:25:28, package.scala:254:43]
  wire [2:0]  _GEN_8 = _GEN_3[2:0] | _GEN_3[4:2];	// @[package.scala:254:43]
  wire        _GEN_9 = _GEN_4 | _GEN_3[1];	// @[package.scala:254:43]
  wire [5:0]  readys_readys = ~({readys_mask[5], _readys_filter_T_1[5] | readys_mask[4], _GEN_3[4] | readys_mask[3], _GEN_7 | readys_mask[2], _GEN_8[2] | readys_mask[1], _GEN_8[1] | _readys_filter_T_1[5] | readys_mask[0]} & {_GEN_8[0] | _GEN_3[4], _GEN_9 | _GEN_7, _GEN_5 | _GEN_3[0] | _GEN_8[2], _GEN_6 | _GEN_4 | _GEN_8[1], auto_out_2_d_valid | auto_out_3_d_valid | _GEN_5 | _GEN_8[0], auto_out_1_d_valid | auto_out_2_d_valid | _GEN_6 | _GEN_9});	// @[Arbiter.scala:24:23, :25:28, :26:58, :27:{18,29,39,48}, package.scala:254:43]
  ...
  wire        out_21_valid = idle ? _sink_ACancel_earlyValid_T | auto_out_2_d_valid | auto_out_3_d_valid | auto_out_4_d_valid | auto_out_5_d_valid : state_0 & auto_out_0_d_valid | state_1 & auto_out_1_d_valid | state_2 & auto_out_2_d_valid | state_3 & auto_out_3_d_valid | state_4 & auto_out_4_d_valid | state_5 & auto_out_5_d_valid;	// @[Arbiter.scala:89:28, :108:36, :117:26, :126:{29,56}, Mux.scala:27:73]
  ...
  wire [5:0]  _readys_mask_T = readys_readys & readys_valid;	// @[Arbiter.scala:27:18, :29:29, Cat.scala:33:92]
  wire [5:0]  _readys_mask_T_3 = _readys_mask_T | {_readys_mask_T[4:0], 1'h0};	// @[Arbiter.scala:29:29, package.scala:245:{43,53}]
  wire [5:0]  _readys_mask_T_6 = _readys_mask_T_3 | {_readys_mask_T_3[3:0], 2'h0};	// @[Arbiter.scala:88:30, package.scala:245:{43,53}]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      readys_mask <= 6'h3F;	// @[Arbiter.scala:24:23, package.scala:235:64]
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[5:3]) : 3'h0) | (winnerQual_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0) | (winnerQual_2 & auto_out_2_d_bits_opcode[0] ? ~(_beatsDO_decode_T_9[5:3]) : 3'h0) | (winnerQual_3 & auto_out_3_d_bits_opcode[0] ? ~(_beatsDO_decode_T_13[5:3]) : 3'h0) | (winnerQual_4 & auto_out_4_d_bits_opcode[0] ? ~(_beatsDO_decode_T_17[5:3]) : 3'h0) | (winnerQual_5 & auto_out_5_d_bits_opcode[0] ? ~(_beatsDO_decode_T_21[5:3]) : 3'h0);	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:259:74, Edges.scala:106:36, :221:14, package.scala:235:{46,71,76}]
      else	// @[Arbiter.scala:90:24]
        beatsLeft <= beatsLeft - {2'h0, auto_in_d_ready & out_21_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, ReadyValidCancel.scala:49:33]
      if (latch & (|readys_valid))	// @[Arbiter.scala:28:{18,27}, :90:24, Cat.scala:33:92]
        readys_mask <= _readys_mask_T_6 | {_readys_mask_T_6[1:0], 4'h0};	// @[Arbiter.scala:24:23, package.scala:245:{43,53}, :254:43]
  ...
  `ifndef SYNTHESIS
    ...
    wire         _T_47 = auto_out_0_d_valid | auto_out_1_d_valid;	// @[Arbiter.scala:109:36]
    always @(posedge clock) begin	// @[Arbiter.scala:106:13]
      if (~reset & ~((~earlyWinner_0 | ~earlyWinner_1) & (~prefixOR_2 | ~earlyWinner_2) & (~prefixOR_3 | ~earlyWinner_3) & (~prefixOR_4 | ~earlyWinner_4) & (~(prefixOR_4 | earlyWinner_4) | ~earlyWinner_5))) begin	// @[Arbiter.scala:98:79, :105:53, :106:{13,61,64,67,82}]
      ...
      if (~reset & ~(~(_sink_ACancel_earlyValid_T | auto_out_2_d_valid | auto_out_3_d_valid | auto_out_4_d_valid | auto_out_5_d_valid) | earlyWinner_0 | earlyWinner_1 | earlyWinner_2 | earlyWinner_3 | earlyWinner_4 | earlyWinner_5)) begin	// @[Arbiter.scala:98:79, :108:{14,15,36,41}]
      ...
      if (~reset & ~(~(_T_47 | auto_out_2_d_valid | auto_out_3_d_valid | auto_out_4_d_valid | auto_out_5_d_valid) | _T_47 | auto_out_2_d_valid | auto_out_3_d_valid | auto_out_4_d_valid | auto_out_5_d_valid)) begin	// @[Arbiter.scala:109:{14,15,36,41}]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readys_mask = _RANDOM_0[8:3];	// @[Arbiter.scala:24:23, :88:30]
        state_0 = _RANDOM_0[9];	// @[Arbiter.scala:88:30, :117:26]
        state_1 = _RANDOM_0[10];	// @[Arbiter.scala:88:30, :117:26]
        state_2 = _RANDOM_0[11];	// @[Arbiter.scala:88:30, :117:26]
        state_3 = _RANDOM_0[12];	// @[Arbiter.scala:88:30, :117:26]
        state_4 = _RANDOM_0[13];	// @[Arbiter.scala:88:30, :117:26]
        state_5 = _RANDOM_0[14];	// @[Arbiter.scala:88:30, :117:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_in_a_ready = requestAIO_0_0 & auto_out_0_a_ready | requestAIO_0_1 & auto_out_1_a_ready | requestAIO_0_2 & auto_out_2_a_ready | requestAIO_0_3 & auto_out_3_a_ready | requestAIO_0_4 & auto_out_4_a_ready | requestAIO_0_5 & auto_out_5_a_ready;	// @[Mux.scala:27:73, Parameters.scala:137:65]
  assign auto_in_d_valid = out_21_valid;	// @[Arbiter.scala:126:29]
  assign auto_in_d_bits_opcode = (muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_opcode : 3'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_opcode : 3'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_opcode : 3'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_opcode : 3'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  assign auto_in_d_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 5'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 5'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_source : 5'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_source : 5'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_source : 5'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_source : 5'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_in_d_bits_data = (muxStateEarly_0 ? auto_out_0_d_bits_data : 64'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_data : 64'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_data : 64'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_data : 64'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_data : 64'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_data : 64'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
