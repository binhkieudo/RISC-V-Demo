...
module SystemBus(
  input         auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_ready,
                auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_d_valid,
  input  [2:0]  auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_d_bits_opcode,
  input  [1:0]  auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_d_bits_size,
  input  [8:0]  auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_d_bits_source,
  input  [63:0] auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_d_bits_data,
  ...
  input         auto_coupler_from_tile_tl_master_clock_xing_in_3_a_bits_source,
  input  [31:0] auto_coupler_from_tile_tl_master_clock_xing_in_3_a_bits_address,
  input  [7:0]  auto_coupler_from_tile_tl_master_clock_xing_in_3_a_bits_mask,
  input  [63:0] auto_coupler_from_tile_tl_master_clock_xing_in_3_a_bits_data,
  ...
  input         auto_coupler_from_tile_tl_master_clock_xing_in_2_a_bits_source,
  ...
  input         auto_coupler_from_tile_tl_master_clock_xing_in_1_a_bits_source,
  ...
  input         auto_coupler_from_tile_tl_master_clock_xing_in_0_a_bits_source,
  ...
  output        auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_valid,
  output [2:0]  auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_bits_opcode,
  output [1:0]  auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_bits_size,
  output [8:0]  auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_bits_source,
  output [31:0] auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_bits_address,
  output [7:0]  auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_bits_mask,
  output [63:0] auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_bits_data,
  output        auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_d_ready,
  ...
  output        auto_coupler_from_tile_tl_master_clock_xing_in_3_d_bits_source,
  output [1:0]  auto_coupler_from_tile_tl_master_clock_xing_in_3_d_bits_sink,
  output        auto_coupler_from_tile_tl_master_clock_xing_in_3_d_bits_denied,
  output [63:0] auto_coupler_from_tile_tl_master_clock_xing_in_3_d_bits_data,
  ...
  output        auto_coupler_from_tile_tl_master_clock_xing_in_2_d_bits_source,
  output [1:0]  auto_coupler_from_tile_tl_master_clock_xing_in_2_d_bits_sink,
  ...
  output        auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_source,
  output [1:0]  auto_coupler_from_tile_tl_master_clock_xing_in_1_d_bits_sink,
  ...
  output        auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_source,
  output [1:0]  auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_sink,
  ...
  wire        _coupler_to_subsystem_sbusscratchpad00_auto_tl_in_a_ready;	// @[LazyModule.scala:489:27]
  wire        _coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_valid;	// @[LazyModule.scala:489:27]
  wire [2:0]  _coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_bits_opcode;	// @[LazyModule.scala:489:27]
  wire [2:0]  _coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_bits_size;	// @[LazyModule.scala:489:27]
  wire [4:0]  _coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  wire [63:0] _coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_bits_data;	// @[LazyModule.scala:489:27]
  ...
  wire        _fixer_auto_out_4_a_bits_source;	// @[FIFOFixer.scala:146:27]
  wire [31:0] _fixer_auto_out_4_a_bits_address;	// @[FIFOFixer.scala:146:27]
  wire [7:0]  _fixer_auto_out_4_a_bits_mask;	// @[FIFOFixer.scala:146:27]
  wire [63:0] _fixer_auto_out_4_a_bits_data;	// @[FIFOFixer.scala:146:27]
  ...
  wire        _fixer_auto_out_3_a_bits_source;	// @[FIFOFixer.scala:146:27]
  wire [31:0] _fixer_auto_out_3_a_bits_address;	// @[FIFOFixer.scala:146:27]
  wire [7:0]  _fixer_auto_out_3_a_bits_mask;	// @[FIFOFixer.scala:146:27]
  wire [63:0] _fixer_auto_out_3_a_bits_data;	// @[FIFOFixer.scala:146:27]
  ...
  wire        _fixer_auto_out_2_a_bits_source;	// @[FIFOFixer.scala:146:27]
  wire [31:0] _fixer_auto_out_2_a_bits_address;	// @[FIFOFixer.scala:146:27]
  wire [7:0]  _fixer_auto_out_2_a_bits_mask;	// @[FIFOFixer.scala:146:27]
  wire [63:0] _fixer_auto_out_2_a_bits_data;	// @[FIFOFixer.scala:146:27]
  ...
  wire        _system_bus_xbar_auto_in_4_d_bits_source;	// @[SystemBus.scala:40:43]
  wire [1:0]  _system_bus_xbar_auto_in_4_d_bits_sink;	// @[SystemBus.scala:40:43]
  ...
  wire        _system_bus_xbar_auto_in_3_d_bits_source;	// @[SystemBus.scala:40:43]
  wire [1:0]  _system_bus_xbar_auto_in_3_d_bits_sink;	// @[SystemBus.scala:40:43]
  ...
  wire        _system_bus_xbar_auto_in_2_d_bits_source;	// @[SystemBus.scala:40:43]
  wire [1:0]  _system_bus_xbar_auto_in_2_d_bits_sink;	// @[SystemBus.scala:40:43]
  ...
  wire [2:0]  _system_bus_xbar_auto_out_2_a_bits_size;	// @[SystemBus.scala:40:43]
  wire [4:0]  _system_bus_xbar_auto_out_2_a_bits_source;	// @[SystemBus.scala:40:43]
  ...
  TLXbar system_bus_xbar (	// @[SystemBus.scala:40:43]
    ...
    .auto_out_2_a_ready        (_coupler_to_subsystem_sbusscratchpad00_auto_tl_in_a_ready),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_valid        (_coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_valid),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_bits_opcode  (_coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_bits_opcode),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_bits_size    (_coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_bits_size),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_bits_source  (_coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_bits_source),	// @[LazyModule.scala:489:27]
    .auto_out_2_d_bits_data    (_coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_bits_data),	// @[LazyModule.scala:489:27]
  ...
  TLFIFOFixer fixer (	// @[FIFOFixer.scala:146:27]
    .auto_in_4_a_valid         (auto_coupler_from_tile_tl_master_clock_xing_in_3_a_valid),
    .auto_in_4_a_bits_opcode   (auto_coupler_from_tile_tl_master_clock_xing_in_3_a_bits_opcode),
    .auto_in_4_a_bits_param    (auto_coupler_from_tile_tl_master_clock_xing_in_3_a_bits_param),
    .auto_in_4_a_bits_size     (auto_coupler_from_tile_tl_master_clock_xing_in_3_a_bits_size),
    .auto_in_4_a_bits_source   (auto_coupler_from_tile_tl_master_clock_xing_in_3_a_bits_source),
    .auto_in_4_a_bits_address  (auto_coupler_from_tile_tl_master_clock_xing_in_3_a_bits_address),
    .auto_in_4_a_bits_mask     (auto_coupler_from_tile_tl_master_clock_xing_in_3_a_bits_mask),
    .auto_in_4_a_bits_data     (auto_coupler_from_tile_tl_master_clock_xing_in_3_a_bits_data),
    .auto_in_4_a_bits_corrupt  (auto_coupler_from_tile_tl_master_clock_xing_in_3_a_bits_corrupt),
    .auto_in_4_d_ready         (auto_coupler_from_tile_tl_master_clock_xing_in_3_d_ready),
    ...
    .auto_in_4_a_ready         (auto_coupler_from_tile_tl_master_clock_xing_in_3_a_ready),
    .auto_in_4_d_valid         (auto_coupler_from_tile_tl_master_clock_xing_in_3_d_valid),
    .auto_in_4_d_bits_opcode   (auto_coupler_from_tile_tl_master_clock_xing_in_3_d_bits_opcode),
    .auto_in_4_d_bits_param    (auto_coupler_from_tile_tl_master_clock_xing_in_3_d_bits_param),
    .auto_in_4_d_bits_size     (auto_coupler_from_tile_tl_master_clock_xing_in_3_d_bits_size),
    .auto_in_4_d_bits_source   (auto_coupler_from_tile_tl_master_clock_xing_in_3_d_bits_source),
    .auto_in_4_d_bits_sink     (auto_coupler_from_tile_tl_master_clock_xing_in_3_d_bits_sink),
    .auto_in_4_d_bits_denied   (auto_coupler_from_tile_tl_master_clock_xing_in_3_d_bits_denied),
    .auto_in_4_d_bits_data     (auto_coupler_from_tile_tl_master_clock_xing_in_3_d_bits_data),
    .auto_in_4_d_bits_corrupt  (auto_coupler_from_tile_tl_master_clock_xing_in_3_d_bits_corrupt),
  ...
  TLInterconnectCoupler_7 coupler_to_subsystem_sbusscratchpad00 (	// @[LazyModule.scala:489:27]
    .clock                              (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                              (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
    .auto_fragmenter_out_a_ready        (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_ready),
    .auto_fragmenter_out_d_valid        (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_d_valid),
    .auto_fragmenter_out_d_bits_opcode  (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_d_bits_opcode),
    .auto_fragmenter_out_d_bits_size    (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_d_bits_size),
    .auto_fragmenter_out_d_bits_source  (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_d_bits_source),
    .auto_fragmenter_out_d_bits_data    (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_d_bits_data),
    ...
    .auto_fragmenter_out_a_valid        (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_valid),
    .auto_fragmenter_out_a_bits_opcode  (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_bits_opcode),
    .auto_fragmenter_out_a_bits_size    (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_bits_size),
    .auto_fragmenter_out_a_bits_source  (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_bits_source),
    .auto_fragmenter_out_a_bits_address (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_bits_address),
    .auto_fragmenter_out_a_bits_mask    (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_bits_mask),
    .auto_fragmenter_out_a_bits_data    (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_a_bits_data),
    .auto_fragmenter_out_d_ready        (auto_coupler_to_subsystem_sbusscratchpad00_fragmenter_out_d_ready),
    .auto_tl_in_a_ready                 (_coupler_to_subsystem_sbusscratchpad00_auto_tl_in_a_ready),
    .auto_tl_in_d_valid                 (_coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_valid),
    .auto_tl_in_d_bits_opcode           (_coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_bits_opcode),
    .auto_tl_in_d_bits_size             (_coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_bits_size),
    .auto_tl_in_d_bits_source           (_coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_bits_source),
    .auto_tl_in_d_bits_data             (_coupler_to_subsystem_sbusscratchpad00_auto_tl_in_d_bits_data)
  );
