  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_1 = `RANDOM;
        _RANDOM_2 = `RANDOM;
        mem_0 = _RANDOM_0[7:0];	// @[AsyncQueue.scala:80:16]
        mem_1 = _RANDOM_0[15:8];	// @[AsyncQueue.scala:80:16]
        mem_2 = _RANDOM_0[23:16];	// @[AsyncQueue.scala:80:16]
        mem_3 = _RANDOM_0[31:24];	// @[AsyncQueue.scala:80:16]
        mem_4 = _RANDOM_1[7:0];	// @[AsyncQueue.scala:80:16]
        mem_5 = _RANDOM_1[15:8];	// @[AsyncQueue.scala:80:16]
        mem_6 = _RANDOM_1[23:16];	// @[AsyncQueue.scala:80:16]
        mem_7 = _RANDOM_1[31:24];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_2[3:0];	// @[AsyncQueue.scala:52:25]
        ready_reg = _RANDOM_2[4];	// @[AsyncQueue.scala:52:25, :88:56]
        widx_gray = _RANDOM_2[8:5];	// @[AsyncQueue.scala:52:25, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 4'h0;	// @[AsyncQueue.scala:52:25, :53:23]
