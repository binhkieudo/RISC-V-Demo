...
module AsyncQueueSink(
  ...
  wire [7:0][7:0] _GEN = {{io_async_mem_7}, {io_async_mem_6}, {io_async_mem_5}, {io_async_mem_4}, {io_async_mem_3}, {io_async_mem_2}, {io_async_mem_1}, {io_async_mem_0}};	// @[SynchronizerReg.scala:209:18]
