...
module PLICFanIn(
  ...
  wire       _T_40 = _T_26 >= _T_38;	// @[Misc.scala:34:9, Plic.scala:345:20]
  assign io_dev = _T_40 ? {1'h0, _T_24 ? {1'h0, _T_8 ? {1'h0, ~_T} : {1'h1, ~_T_4}} : {1'h1, _T_20 ? {1'h0, ~_T_12} : {1'h1, ~_T_16}}} : {2'h2, _T_36 ? {1'h0, ~_T_28} : {1'h1, ~_T_32}};	// @[Misc.scala:34:36, Plic.scala:345:{20,57}, :349:32]
  assign io_max = _T_40 ? _T_26[2:0] : _T_38[2:0];	// @[Misc.scala:34:9, Plic.scala:345:20]
endmodule
