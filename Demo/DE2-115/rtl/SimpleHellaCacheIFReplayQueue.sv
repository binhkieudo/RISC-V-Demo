...
module SimpleHellaCacheIFReplayQueue(
  ...
  wire replay_complete = io_resp_valid & replaying & io_resp_bits_tag == 9'h0;	// @[SimpleHellaCacheIF.scala:35:17, :45:26, :65:{52,72}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_7 = `RANDOM;
        _RANDOM_8 = `RANDOM;
        replaying = _RANDOM_8[16];	// @[SimpleHellaCacheIF.scala:45:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_22 nackq (	// @[SimpleHellaCacheIF.scala:44:21]
    .clock        (clock),
    .reset        (reset),
  ...
  assign io_replay_bits_tag = 9'h0;	// @[SimpleHellaCacheIF.scala:35:17]
