  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        elts_0_pc = {_RANDOM_1[31:28], _RANDOM_2, _RANDOM_3[3:0]};	// @[ShiftQueue.scala:22:25]
        elts_0_data = {_RANDOM_3[31:4], _RANDOM_4[3:0]};	// @[ShiftQueue.scala:22:25]
        elts_0_xcpt_pf_inst = _RANDOM_4[6];	// @[ShiftQueue.scala:22:25]
        elts_0_xcpt_gf_inst = _RANDOM_4[7];	// @[ShiftQueue.scala:22:25]
        elts_0_xcpt_ae_inst = _RANDOM_4[8];	// @[ShiftQueue.scala:22:25]
        elts_0_replay = _RANDOM_4[9];	// @[ShiftQueue.scala:22:25]
        elts_1_btb_taken = _RANDOM_4[12];	// @[ShiftQueue.scala:22:25]
        elts_1_btb_bridx = _RANDOM_4[15];	// @[ShiftQueue.scala:22:25]
        elts_1_pc = {_RANDOM_6[31:1], _RANDOM_7[8:0]};	// @[ShiftQueue.scala:22:25]
        elts_1_data = {_RANDOM_7[31:9], _RANDOM_8[8:0]};	// @[ShiftQueue.scala:22:25]
        elts_1_xcpt_pf_inst = _RANDOM_8[11];	// @[ShiftQueue.scala:22:25]
        elts_1_xcpt_gf_inst = _RANDOM_8[12];	// @[ShiftQueue.scala:22:25]
        elts_1_xcpt_ae_inst = _RANDOM_8[13];	// @[ShiftQueue.scala:22:25]
        elts_1_replay = _RANDOM_8[14];	// @[ShiftQueue.scala:22:25]
        elts_2_btb_taken = _RANDOM_8[17];	// @[ShiftQueue.scala:22:25]
        elts_2_btb_bridx = _RANDOM_8[20];	// @[ShiftQueue.scala:22:25]
        elts_2_pc = {_RANDOM_10[31:6], _RANDOM_11[13:0]};	// @[ShiftQueue.scala:22:25]
        elts_2_data = {_RANDOM_11[31:14], _RANDOM_12[13:0]};	// @[ShiftQueue.scala:22:25]
        elts_2_xcpt_pf_inst = _RANDOM_12[16];	// @[ShiftQueue.scala:22:25]
        elts_2_xcpt_gf_inst = _RANDOM_12[17];	// @[ShiftQueue.scala:22:25]
        elts_2_xcpt_ae_inst = _RANDOM_12[18];	// @[ShiftQueue.scala:22:25]
        elts_2_replay = _RANDOM_12[19];	// @[ShiftQueue.scala:22:25]
        elts_3_btb_taken = _RANDOM_12[22];	// @[ShiftQueue.scala:22:25]
        elts_3_btb_bridx = _RANDOM_12[25];	// @[ShiftQueue.scala:22:25]
        elts_3_pc = {_RANDOM_14[31:11], _RANDOM_15[18:0]};	// @[ShiftQueue.scala:22:25]
        elts_3_data = {_RANDOM_15[31:19], _RANDOM_16[18:0]};	// @[ShiftQueue.scala:22:25]
        elts_3_xcpt_pf_inst = _RANDOM_16[21];	// @[ShiftQueue.scala:22:25]
        elts_3_xcpt_gf_inst = _RANDOM_16[22];	// @[ShiftQueue.scala:22:25]
        elts_3_xcpt_ae_inst = _RANDOM_16[23];	// @[ShiftQueue.scala:22:25]
        elts_3_replay = _RANDOM_16[24];	// @[ShiftQueue.scala:22:25]
        elts_4_btb_taken = _RANDOM_16[27];	// @[ShiftQueue.scala:22:25]
        elts_4_btb_bridx = _RANDOM_16[30];	// @[ShiftQueue.scala:22:25]
        elts_4_pc = {_RANDOM_18[31:16], _RANDOM_19[23:0]};	// @[ShiftQueue.scala:22:25]
        elts_4_data = {_RANDOM_19[31:24], _RANDOM_20[23:0]};	// @[ShiftQueue.scala:22:25]
        elts_4_xcpt_pf_inst = _RANDOM_20[26];	// @[ShiftQueue.scala:22:25]
        elts_4_xcpt_gf_inst = _RANDOM_20[27];	// @[ShiftQueue.scala:22:25]
        elts_4_xcpt_ae_inst = _RANDOM_20[28];	// @[ShiftQueue.scala:22:25]
        elts_4_replay = _RANDOM_20[29];	// @[ShiftQueue.scala:22:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
