  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _id_stall_fpu_r = {_RANDOM_37[31:27], _RANDOM_38[26:0]};	// @[RocketCore.scala:1131:29]
        dcache_blocked_blocked = _RANDOM_38[27];	// @[RocketCore.scala:889:22, :1131:29]
        rocc_blocked = _RANDOM_38[28];	// @[RocketCore.scala:893:25, :1131:29]
        io_imem_progress_REG = _RANDOM_38[29];	// @[RocketCore.scala:922:30, :1131:29]
        coreMonitorBundle_rd0val_REG = {_RANDOM_38[31], _RANDOM_39, _RANDOM_40[30:0]};	// @[RocketCore.scala:1025:46, :1131:29]
        coreMonitorBundle_rd0val_REG_1 = {_RANDOM_40[31], _RANDOM_41, _RANDOM_42[30:0]};	// @[RocketCore.scala:1025:{38,46}]
        coreMonitorBundle_rd1val_REG = {_RANDOM_42[31], _RANDOM_43, _RANDOM_44[30:0]};	// @[RocketCore.scala:1025:38, :1027:46]
        coreMonitorBundle_rd1val_REG_1 = {_RANDOM_44[31], _RANDOM_45, _RANDOM_46[30:0]};	// @[RocketCore.scala:1027:{38,46}]
      `endif // RANDOMIZE_REG_INIT
    end // initial
