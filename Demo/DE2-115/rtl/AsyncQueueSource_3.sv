  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        mem_0_hrmask_0 = _RANDOM_0[17];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_1 = _RANDOM_0[18];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_2 = _RANDOM_0[19];	// @[AsyncQueue.scala:80:16]
        mem_0_hrmask_3 = _RANDOM_0[20];	// @[AsyncQueue.scala:80:16]
        widx_widx_bin = _RANDOM_0[21];	// @[AsyncQueue.scala:52:25, :80:16]
        ready_reg = _RANDOM_0[22];	// @[AsyncQueue.scala:80:16, :88:56]
        widx_gray = _RANDOM_0[23];	// @[AsyncQueue.scala:80:16, :91:55]
      `endif // RANDOMIZE_REG_INIT
      `ifdef RANDOMIZE
        if (reset) begin
          widx_widx_bin = 1'h0;	// @[AsyncQueue.scala:52:25, :80:16]
