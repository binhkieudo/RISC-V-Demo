...
module FPU(
  ...
  wire [64:0]      _wdata_T_25 = _GEN_0[wbInfo_0_pipeid];	// @[FPU.scala:908:19, package.scala:33:{76,86}]
  wire [64:0]      wdata_1 = wbInfo_0_typeTag ? _wdata_T_25 : {12'hFFF, _wdata_T_25[31], 20'hFFFFF, _wdata_T_25[32], _wdata_T_25[30:0]};	// @[Cat.scala:33:92, FPU.scala:332:42, :334:8, :336:8, :337:8, :908:19, package.scala:33:76]
  ...
  wire             _T_26 = ~wbInfo_0_cp & wen[0];	// @[FPU.scala:907:20, :908:19, :935:{10,24,30}]
  ...
  wire             _wbInfo_2_pipeid_T_2 = mem_ctrl_typeTagOut == 2'h0;	// @[FPU.scala:879:72, Reg.scala:19:16]
  wire             _memLatencyMask_T_3 = mem_ctrl_fma & _wbInfo_2_pipeid_T_2;	// @[FPU.scala:879:{56,72}, Reg.scala:19:16]
  wire             _io_sboard_set_T_2 = mem_ctrl_typeTagOut == 2'h1;	// @[FPU.scala:884:78, Reg.scala:19:16, rawFloatFromFN.scala:60:27]
  wire             _memLatencyMask_T_6 = mem_ctrl_fma & _io_sboard_set_T_2;	// @[FPU.scala:884:{62,78}, Reg.scala:19:16]
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_3) begin	// @[FPU.scala:914:21, :917:18, :922:52, :923:22]
      ...
      wbInfo_0_pipeid <= {mem_ctrl_fma & _wbInfo_2_pipeid_T_2, mem_ctrl_fromint} | {2{mem_ctrl_fma & _io_sboard_set_T_2}};	// @[FPU.scala:879:{56,72}, :884:{62,78}, :896:{63,100}, :908:19, Reg.scala:19:16]
    end
    ...
    if (_GEN_4) begin	// @[FPU.scala:914:21, :917:18, :922:52, :923:22]
      ...
      wbInfo_1_pipeid <= {mem_ctrl_fma & _wbInfo_2_pipeid_T_2, mem_ctrl_fromint} | {2{mem_ctrl_fma & _io_sboard_set_T_2}};	// @[FPU.scala:879:{56,72}, :884:{62,78}, :896:{63,100}, :908:19, Reg.scala:19:16]
    end
    ...
    if (_GEN_5) begin	// @[FPU.scala:908:19, :917:18, :922:52, :923:22]
      ...
      wbInfo_2_pipeid <= {mem_ctrl_fma & _wbInfo_2_pipeid_T_2, mem_ctrl_fromint} | {2{mem_ctrl_fma & _io_sboard_set_T_2}};	// @[FPU.scala:879:{56,72}, :884:{62,78}, :896:{63,100}, :908:19, Reg.scala:19:16]
    end
    ...
    io_sboard_set_REG <= mem_ctrl_fma & _io_sboard_set_T_2 | mem_ctrl_div | mem_ctrl_sqrt;	// @[FPU.scala:884:{62,78}, :968:{59,111}, Reg.scala:19:16]
  end // always @(posedge)
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[FPU.scala:797:11]
      ...
      if (_T_26 & ~reset & ~(wdata_1[63:61] != 3'h7 | wdata_1[60] == (&(wdata_1[51:32])))) begin	// @[FPU.scala:243:{25,56}, :379:{31,35,55,60,96}, :935:24, :936:11, package.scala:33:76]
  ...
  assign io_fcsr_flags_bits = (wb_toint_valid ? wb_toint_exc : 5'h0) | (wen[0] ? _GEN_1[wbInfo_0_pipeid] : 5'h0);	// @[FPU.scala:907:20, :908:19, :935:30, :955:37, :959:8, :960:42, :961:8, Reg.scala:19:16, package.scala:33:{76,86}]
  ...
  assign io_sboard_clr = wen[0] & (&wbInfo_0_pipeid);	// @[FPU.scala:907:20, :908:19, :935:30, :969:60, package.scala:33:86]
  assign io_sboard_clra = wbInfo_0_rd;	// @[FPU.scala:908:19]
endmodule
