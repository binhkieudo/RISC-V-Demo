...
module TLXbar_7(
  ...
  assign auto_out_a_bits_address = (x1_out_1_bits_source ? auto_in_0_a_bits_address : 32'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_address : 32'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_mask = (x1_out_1_bits_source ? auto_in_0_a_bits_mask : 8'h0) | {8{muxStateEarly_1}};	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_data = x1_out_1_bits_source ? auto_in_0_a_bits_data : 64'h0;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
