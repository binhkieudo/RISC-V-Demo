...
module serQueue_28(
  ...
  serram_combMem_14 ram_ext (	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[49:19];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[57:50];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[121:58];	// @[Decoupled.scala:273:95]
endmodule
