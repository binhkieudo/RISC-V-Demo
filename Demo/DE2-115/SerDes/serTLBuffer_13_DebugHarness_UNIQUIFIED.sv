module serTLBuffer_13_DebugHarness_UNIQUIFIED(
  input         clock,
                reset,
                auto_in_a_valid,
  ...
  serQueue_21_DebugHarness_UNIQUIFIED x1_a_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  serQueue_22_DebugHarness_UNIQUIFIED bundleIn_0_d_q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
