...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  ram_RW_0_r_en;
  wire [LOGDEPTH-1:0] ram_RW_0_r_addr;
  wire [7:0] ram_RW_0_r_data;
  wire [7:0] ram_RW_0_w_data;
  wire [LOGDEPTH-1:0] ram_RW_0_w_addr;
  wire  ram_RW_0_w_mask;
  wire  ram_RW_0_w_en;
  reg  ram_RW_0_r_en_pipe_0;
  reg [LOGDEPTH-1:0] ram_RW_0_r_addr_pipe_0;
  ...
  assign ram_RW_0_w_addr = RW0_addr[LOGDEPTH-1:0];
  ...
  always @(posedge RW0_clk) begin
    ...
    if (RW0_en & ~RW0_wmode) begin
      ram_RW_0_r_addr_pipe_0 <= RW0_addr[LOGDEPTH-1:0];
    end
  end
...
`ifdef RANDOMIZE_MEM_INIT
  _RAND_0 = {1{`RANDOM}};
  for (initvar = 0; initvar < RAMSIZE; initvar = initvar+1)
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_2 = {1{`RANDOM}};
  ram_RW_0_r_addr_pipe_0 = _RAND_2[LOGDEPTH-1:0];
`endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
