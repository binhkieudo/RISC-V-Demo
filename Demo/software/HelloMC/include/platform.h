...
#define MEMORY_MEM_SIZE   _AC(0x4000,UL)

#define THREAD_QUEUE_ADDR _AC(0x70000000,UL)
...
#define PRIVATE_MEM_1     _AC(0x40001000,UL)
#define PRIVATE_MEM_2     _AC(0x40002000,UL)
#define PRIVATE_MEM_3     _AC(0x40003000,UL)
#define PRIVATE_MEM_SIZE  _AC(0x1000,UL)
