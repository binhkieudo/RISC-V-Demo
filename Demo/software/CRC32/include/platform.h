...
#define THREAD_QUEUE_ADDR _AC(0x80002000,UL)
#define THREAD_QUEUE_SIZE _AC(0x2000,UL)
...
// IOF masks
#define PRIVATE_MEM_0     _AC(0x40000000,UL)
#define PRIVATE_MEM_1     _AC(0x40008000,UL)
#define PRIVATE_MEM_2     _AC(0x40010000,UL)
#define PRIVATE_MEM_3     _AC(0x40018000,UL)
#define PRIVATE_MEM_4     _AC(0x40020000,UL)
#define PRIVATE_MEM_5     _AC(0x40028000,UL)
#define PRIVATE_MEM_6     _AC(0x40030000,UL)
#define PRIVATE_MEM_7     _AC(0x40038000,UL)
#define PRIVATE_MEM_SIZE  _AC(0x8000,UL)
